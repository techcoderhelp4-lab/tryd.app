...
import '../../challenges/presentation/leaderboard_screen.dart';
...
class _ClubScreenState extends ConsumerState<ClubScreen> with AutomaticKeepAliveClientMixin {
  @override
                      ...
                      Padding(
                        ...
                        child: ref.watch(challengesListProvider).when(
                          data: (challenges) {
                            ...
                            final activeChallenges = challenges.where((c) => c.isJoined && c.endDate.isAfter(now)).toList();
                            // All ended challenges — both joined and non-joined — are "previous"
                            final previousChallenges = challenges.where((c) => !c.endDate.isAfter(now)).toList();
        ...
        await Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => isActive
                ? MyChallengeScreen(challenge: challenge)
                : LeaderboardScreen(challengeId: challenge.id),
          ),
        );
        ref.invalidate(challengesListProvider);
      },
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: 4.0 * scale, vertical: 8.0 * scale),
                    child: Column(
